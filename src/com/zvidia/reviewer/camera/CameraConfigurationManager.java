...
public final class CameraConfigurationManager {
	...
	CameraConfigurationManager(CaptureActivity activity) {
	...
	void setDesiredCameraParameters(Camera camera, boolean safeMode) {
		...
		if (prefs.getBoolean(PreferencesActivity.KEY_AUTO_FOCUS, true)) {
			if (safeMode || prefs.getBoolean(PreferencesActivity.KEY_DISABLE_CONTINUOUS_FOCUS, false)) {
				...
				focusMode = findSettableValue(parameters.getSupportedFocusModes(), Camera.Parameters.FOCUS_MODE_CONTINUOUS_PICTURE,// "continuous-picture",
																																	// //
	...
	private Point findBestPreviewSizeValue(Camera.Parameters parameters, Point screenResolution) {
		...
		// List<Camera.Size> supportedPreviewSizes = new
		...
		//
		// Point bestSize = null;
		// // float screenAspectRatio = (float) screenResolution.x / (float)
		// // screenResolution.y;
		// // 只支持纵向的屏幕
		// float screenAspectRatio = (float) screenResolution.x / (float)
		// screenResolution.y;
		...
		// // bestSize = new Point(realHeight, realHeight);
		// // break;
		// // }
		...
		// realHeight;
		// if (maybeFlippedWidth == screenResolution.x && maybeFlippedHeight ==
		// screenResolution.y) {
		...
		// return exactPoint;
		// }
		// float aspectRatio = (float) maybeFlippedHeight / (float)
		// maybeFlippedWidth;
