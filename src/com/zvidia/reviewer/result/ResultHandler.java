...
package com.zvidia.reviewer.result;
...
import com.zvidia.reviewer.activity.LocaleManager;
import com.zvidia.reviewer.activity.PreferencesActivity;
import com.zvidia.reviewer.qrcode.Contents;
...
public abstract class ResultHandler {
	...
	final void addContact(String[] names, String[] nicknames, String pronunciation, String[] phoneNumbers, String[] phoneTypes,
			String[] emails, String[] emailTypes, String note, String instantMessenger, String address, String addressType, String org,
	...
	final void getDirections(double latitude, double longitude) {
		launchIntent(new Intent(Intent.ACTION_VIEW, Uri.parse("http://maps.google." + LocaleManager.getCountryTLD(activity)
